"""
Visualization script for aligned fused LiDAR data with bounding box labels.

This script processes aligned fused range images and their corresponding YOLO format labels
...
visualization of both normal and cleaned datasets.
"""
...
if __name__ == "__main__":
    ...
    # Setup input and output directories for aligned fused data
    ...
    range_images_dir = Path("output/multi_frame/multi_scenarios/aligned_fused") / f"{prefix}X_5_frame_aligned_fused_{raw_log_name}"
    labels_dir = Path("output/multi_frame/multi_scenarios/aligned_fused") / f"{prefix}Y_5_frame_aligned_fused_{raw_log_name}"
    
    # Define output directory for visualizations
    output_dir = Path("output/multi_frame/multi_scenarios/aligned_fused_visualize") / f"visualize_{data_type}_5_frame_aligned_fused_{raw_log_name}"
    ...
    if output_paths:
        video_path = output_dir / f"visualize_{data_type}_5_frame_aligned_fused_{raw_log_name}.mp4"
